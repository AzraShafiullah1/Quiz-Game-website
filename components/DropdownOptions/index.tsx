...
export default function DropdownOptions() {
  ...
  return (
    <>
      <section className="flex justify-evenly items-center bg-purple-500 py-5">
        {/* Shadcdn */}
        <div className="px-7 py-4 border-gray-300 border-2 rounded-xl  bg-yellow-300 w-1/3 mx-4">
          <DropdownMenu>
        ...
        {/* Shadcdn */}
        <div className="px-7 py-4 border-gray-100 border-2 rounded-xl bg-yellow-300 w-1/3 mx-4">
          <DropdownMenu>
            <DropdownMenuTrigger className="flex outline-none justify-between w-full">
        ...
        {/* Shadcdn */}
        <div className="px-7 py-4 border-gray-100 border-2 bg-yellow-300  rounded-xl w-1/3 mx-4">
          <DropdownMenu>
            <DropdownMenuTrigger className="flex outline-none justify-between w-full">
